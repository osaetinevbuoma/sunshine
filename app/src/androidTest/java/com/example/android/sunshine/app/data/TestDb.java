...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Weather validation failed", cursor, contentValues);

        // Move the cursor to demonstrate that there is only one record in the database
        assertFalse("Error: more than one record in weather table", cursor.moveToNext());
    ...
    public long insertLocation() {
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Location Validation error", cursor, testValues);

        // Move the cursor to demonstrate that there is only one record in the database
        assertFalse("Error: more than one record in location table", cursor.moveToNext());
